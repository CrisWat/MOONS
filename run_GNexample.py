...
# -*- coding: utf-8 -*-
"""
Created on Sun May 22 19:09:11 2022
...
#path_save = "/Users/cristiano/software/MOONLIGHT/test5_GN/"
path_save = "/Users/cristiano/phd/GitHub/MOONS_2/dir/"
...
hdul=fits.open("/Users/cristiano/phd/NICE/catalogues/GN_ID.fits") # Edit here for your input FITS binary table FIELD INPUT catalogue
data = hdul[1].data
f_in=hdul[1].data
...
c = SkyCoord(ra=ra*u.degree, dec=dec*u.degree, unit='deg')
gal_c = c.galactic
l = gal_c.l.degree
li = np.where(l>180)
l[li] = l[li]-360
...
cat.read_input_namelist("namelist", from_line="yes")
#If you want to start with data already extracted
cat.import_catalogue_fromline(ID, ra, dec, l, b, J, H, Ks, np.zeros(len(Ks)))

ID00, ra00, dec00, l00, b00, J00, H00, Ks00, e00 = cat.get_data()
...
cat.spherical_cut_radec()
#cat.spherical_cut()
ID01, ra01, dec01, l01, b01, J01, H01, Ks01, e01 = cat.get_data()


#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
fig, ax = plt.subplots(figsize=(7,5), dpi=350)
plt.scatter(ra00,dec00,marker='.', color='k', s=0.0001)
plt.scatter(ra01,dec01,marker='.', color='r', s=0.0002, alpha=0.25)
plt.minorticks_on()
plt.show()
plt.close()
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
