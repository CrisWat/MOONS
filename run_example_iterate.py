...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 26 22:34:47 2021
...
for x0 in (-0.8,-0.4,0.0,0.4,0.8):
    for y0 in (0.4,0.0,-0.4):
        ...
        print('Making selection for C=('+str(x0)+','+str(y0)+')...')
        cat.spherical_cut(CENTRE_CUT=(x0,y0), RADIUS_CUT=0.25)
        ...
        #name of the outputs
        name_output = 'field_'+str(x0)+'_'+str(y0)+'_r'+str(cat.RADIUS_CUT)+'.moons'
        ...
        if ((x0 == 0.0) & (y0 == 0.0)):
            ...
            c = cat.make_priority_and_flag(ID_RGB, ra_RGB, dec_RGB, Jmag_RGB, T0_RGB, 3, 'T')
            d = cat.make_priority_and_flag(ID_RC, ra_RC, dec_RC, Jmag_RC, T1_RC, 2, 'T')
            e = cat.make_priority_and_flag(ID_RGB, ra_RGB, dec_RGB, Jmag_RGB, T1_RGB, 4, 'T')
            f = cat.make_priority_and_flag(ID_RC, ra_RC, dec_RC, Jmag_RC, T2_RC, 5, 'T')
            g = cat.make_priority_and_flag(ID_RGB, ra_RGB, dec_RGB, Jmag_RGB, T2_RGB, 6, 'T')
